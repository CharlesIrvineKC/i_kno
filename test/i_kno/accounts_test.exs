defmodule IKno.AccountsTest do
  use IKno.DataCase

  alias IKno.Accounts

  import IKno.AccountsFixtures
  alias IKno.Accounts.{User, UserToken}
  ...
  describe "subject_admins" do
    ...
    test "update_subject_admin/2 with valid data updates the subject_admin" do
      ...
      assert {:ok, %SubjectAdmin{} = subject_admin} =
               Accounts.update_subject_admin(subject_admin, update_attrs)
    end
