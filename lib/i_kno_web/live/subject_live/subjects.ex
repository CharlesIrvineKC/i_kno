        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4">
              ...
              <a :if={@is_super_user} href={~p"/subjects/#{subject.id}/edit"} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                Edit
              </a>
              <a :if={@is_super_user} phx-click="delete-subject" phx-value-subject-id={subject.id} href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                Delete
              </a>
            </td>
          </tr>
