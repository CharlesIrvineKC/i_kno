      ...
      <form class="w-full flex flex-row" phx-submit="save-answer" phx-target={@myself}>
        ...
        <div :if={@is_editing} class="w-full mr-4">
          <input
            ...
            name="answer-input"
            value={@answer.answer}
            class="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="John"
            required
          />
        </div>
