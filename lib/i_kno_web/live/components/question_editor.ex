defmodule IKnoWeb.Components.QuestionEditor do
  ...
  def render_new_button(assigns) do
    ...
    <button
      ...
      phx-target={@myself}
      class="px-3 py-2 text-xs mb-5 font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
    >
      New Multiple Choice
    </button>
    <button
        ...
        <form :if={@is_editing} class="flex flex-row w-full" phx-submit="save-question" phx-target={@myself}>
          ...
          <div class="flex flex-row w-full">
            <input
              ...
              class="m-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500"
              required
            />
          </div>
