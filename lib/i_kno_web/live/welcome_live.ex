  ...
  def render(assigns) do
    ...
    <div class="flex flex-wrap">
      ...
      >
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">
          Information in IKno is organized into <b>subjects</b>
          and <b>topics</b>. A <b>subject</b>
          is composed of a set of <b>topics</b>.
        </p>
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          Currently, IKno subjects are incomplete and have been authored solely for the purpose of testing IKno. The most complete subject and one that will be expanded upon is <b>Business Process Management</b>. There is also a subject describing
          <b>IKno</b>
          itself that you may find of interest.
        </p>
      </a>
      <a
        href="#"
      ...
      >
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">
          <b>Learning mode</b>
          refers to having IKno step you through topics based on what you already know. Topics are ordered from the most fundamental to the most complex.
        </p>
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          There are two ways to use learning mode: at the <b>subject level</b>
          or at the <b>topic level</b>.
        </p>
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          At the <b>topic</b>
          level, IKno will present only those topics required for the understanding of the selected topic.
        </p>
      </a>
      <a
        href="#"
        class="mb-5 mr-5 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg
      ...
      >
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          At some point, IKno will implement mechanisms for revenue generation and revenue sharing with authors. Early adopters will be granted especially generous terms.
        </p>
      </a>
      <a
        href="#"
      ...
      >
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          Again, there are two ways to use testing mode: at the <b>subject level</b>
          or at the <b>topic level</b>.
        </p>
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          At the <b>topic</b>
          level, IKno will present only those questions required relevant to a selected topic.
        </p>
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          <b>Note:</b>
          If the author of an IKno subject hasn't written any questions, testing mode won't be available or visible.
        </p>
      </a>
      <a
        href="#"
      ...
      >
        ...
        <p class="mt-3 font-normal text-gray-700 dark:text-gray-400">
          However, if you want a better understanding or are just curious, you can find detailed information describing IKno by clicking on the
          <b>Explore</b>
          button below and then clicking in the IKno subject.
        </p>
      </a>
    </div>
    <button
